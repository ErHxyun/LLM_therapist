...
class QuestionerRVLoopTest(unittest.TestCase):
    ...
    def test_next_question_uses_pending_intro_in_same_prompt(self):
        question_lib = {
            "1": {
                "1": {
                    "label": "weight",
        ...
        self.assertEqual(
            logged_questions,
            ["Thank you for your clarification. Let's continue our questions. Have your weight changed significantly recently?"],
        )
